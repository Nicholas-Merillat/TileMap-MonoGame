...
namespace TileMap
{
    internal class Player
    {
        ...
        public void Update(float deltaTime)
        {
            ...
            wantToJump = Keyboard.GetState().IsKeyDown(JumpKey);
            
            if (Keyboard.GetState().IsKeyDown(LeftKey)) direction = -1;
            else if (Keyboard.GetState().IsKeyDown(RightKey)) direction = 1;
            else direction = 0;
